...
"""This file contains the personality types and their descriptions."""


ORIGINATOR = """THE ORIGINATOR 1's are originals. Coming up with new ideas and executing them is
...
PEACEMAKER = """THE PEACEMAKER 2's are the born diplomats. They are aware of others' needs and
...
LIFE_OF_THE_PARTY = """THE LIFE OF THE PARTY 3's are idealists. They are very creative, social,
...
CONSERVATIVE = """THE CONSERVATIVE 4's are sensible and traditional. They like order and routine.
...
NONCONFORMIST = """THE NONCONFORMIST 5's are the explorers. Their natural curiosity, risk taking,
...
ROMANTIC = """THE ROMANTIC 6's are idealistic and need to feel useful to be happy. A strong
...
INTELLECTUAL = """THE INTELLECTUAL 7's are the searchers. Always probing for hidden information,
...
BIG_SHOT = """THE BIG SHOT 8's are the problem solvers. They are professional, blunt and to
...
PERFORMER = """THE PERFORMER 9's are natural entertainers. They are very caring and generous,
